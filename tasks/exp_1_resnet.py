...
info = f"resnet_18_r_{senet_r}_lr_{learning_rate}_wd_{weight_decay}_momentum_{momentum}_batch_{batch_size}_epoch_{epochs}"
print(info)

acc_and_loss_saved_filname = f"experiment1_resnet_{info}.json"
model_weight_filename = f"experiment1_resnet_{info}.pth"
...
model = ResNet50(ResNetBlock, r=senet_r)
