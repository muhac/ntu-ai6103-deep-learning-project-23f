...
info = f"{senet_r}_lr_{learning_rate}_wd_{weight_decay}_momentum_{momentum}_batch_{batch_size}_epoch_{epochs}"
print(info)

acc_and_loss_saved_filname = f"final_senet_{info}.json"
model_weight_filename = f"final_senet_{info}.pth"
...
# train, valid = torch.utils.data.random_split(train_dataset, [48000, 2000])

# Create data loaders for training and testing datasets
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=2)
valid_loader = torch.utils.data.DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=2)
